...
text
pydantic-demo/
├── order_system.py  # Модели данных, валидаторы и демонстрационные сценарии
...
Установите библиотеку Pydantic с поддержкой email-валидации:

bash
pip install pydantic[email]
Скачайте файл order_system.py.
...
Валидация заказа с использованием Order (field_validator)

Валидация заказа с использованием OrderBetter (model_validator)

Демонстрация обработки ошибок валидации на некорректных данных
